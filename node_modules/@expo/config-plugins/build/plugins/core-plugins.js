...
exports.withInterceptedMod = exports.withExtendedMod = exports.withDangerousMod = exports.createRunOncePlugin = exports.withRunOnce = exports.withPlugins = void 0;
...
const withPlugins = (config, plugins) => {
    assert_1.default(Array.isArray(plugins), 'withPlugins expected a valid array of plugins or plugin module paths');
