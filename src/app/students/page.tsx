...
export default function Page() {
	...
	return (
		<section className="mx-auto py-10 px-10 max-w-screen-lg md:max-w-screen-md lg:max-w-screen-lg">
			...
			<section className="mx-0 mt-10 h-96 overflow-y-scroll grid justify-items-center md:pr-6 md:mt-16 md:grid-cols-4 gap-6 md:justify-items-start">
				<>
