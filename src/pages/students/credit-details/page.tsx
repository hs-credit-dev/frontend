...
// 								</p>
// 							)}
// 							{!creditDetails?.stakeDetails && <p>{parse(creditDetails?.stake)}</p>}
// 						</div>
// 					</div>
// 				</div>
// 				<div className="basis-1/3 flex justify-center border-r-[3px] border-l-[3px] border-r-solid border-l-solid border-r-black border-l-black">
...
// 					<span className="font-medium italic">{creditDetails?.creditPartner}</span>
// 				</h3>
// 			) : (
// 				<>
...
// 						<span className="font-medium">{statusCheck(creditDetails.status)}</span>
// 					</h3>
// 					<div className="text-[0.625rem]">•</div>
// 					<h3 className="font-normal flex gap-x-1">
